...
public class Config {
    ...
    public final static String TMDB_MOVIE_TRAILERS_ROUTE = "videos";
    public final static String TMDB_MOVIE_REVIEWS_ROUTE = "reviews";
    public final static String TMDB_POPULAR_PARAM = "popular";
    public final static String TMDB_TOP_RATED_PARAM = "top_rated";
    public final static String TMDB_MOVIE_TRAILER_PARAM = "trailers";
    public final static String TMDB_MOVIE_REVIEW_PARAM = "reviews";
